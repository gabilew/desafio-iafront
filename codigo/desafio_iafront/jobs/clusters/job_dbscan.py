...
from codigo.desafio_iafront.jobs.clusters.clusters import dbscan
...
@click.option('--n-samples',  default=0.01, help='percentual amostras a serem utilizadas para clsuterização')
